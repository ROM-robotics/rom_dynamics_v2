...
#include <memory>
#include "../../../ros2/header/subscriber.h"
...
QT_MOC_LITERAL(3, 24, 3) // "log"
    ...
    "Subscriber\0logReceived\0\0log"
};
...
void Subscriber::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Subscriber::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Subscriber::logReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Subscriber::logReceived(const QString & _t1)
{
